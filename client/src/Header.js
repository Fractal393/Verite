    ...
    <header className="w-full bg-white dark:bg-verite_dark p-2">
      ...
      <div className="mx-4 flex relative">
        ...
        <form onSubmit={doSearch} className="bg-verite_light-brighter  dark:bg-verite_dark-brighter  px-3 flex rounded-md border border-gray-400 mx-4 flex-grow">
          ...
          <input type="text" className="bg-verite_light-brighter dark:bg-verite_dark-brighter  text-gray-500 dark:text-gray-400 text-sm p-1 pl-2 pr-0 block focus:outline-none text-none"
                 placeholder="Search"
                 value={searchText}
